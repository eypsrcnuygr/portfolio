  ...
  return (<div>
    ...
    <article className="text-light mb-2 article-3">
      <div className="container">
        <div className="row">
          <div className="col-xl-7 col-12 heading order-2">
            <h5>
            ...
            <p>
              ...
              components.”  In this tutorial based article, you can learn how to
              setup Bootstrap 4 and use it with ease.
            </p>
          ...
          <div className="col-xl-5 col-12 order-1 shadow">
        ...
        <div className="row">
          <div className="col-xl-7 col-12 heading order-2">
            ...
            <p>
              ...
              power of quick design and responsive mobile-first site layout. It
              lays on top of the 12 grid system and it has extensive pre-built
              components." In this article, you can see the difference between
              Bootstrap 4 and 5 and understand the important changes that
              happened.
            </p>
            <div className="d-flex mt-5 py-2">
              <p className="mx-2 bg-info rounded labels pt-2 px-2">Bootstrap</p>
              <p className="mx-2 bg-info rounded labels pt-2 px-2">CSS, SCSS</p>
          ...
          <div className="col-xl-5 col-12 order-1 shadow">
            <img src="/Bootstrap5.png" alt="Easy-Pay" className="w-100 h-100" />
          </div>
        </div>
      </div>
    </article>
      ...
      <div className="container">
        <div className="row">
          <div className="col-xl-7 col-12 heading order-2">
            ...
            <p>
              "Animations are very useful tools to make pages more appealing. I
              would like to start with what are animations, give some
